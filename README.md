...
This repository contains a frontend solution for my university bachelor's project. The frontend is build using React Native with Expo.
## Table of contents
...
2. Run `npm install`
3. Use AuroraIgloosEngineering.bak file for database
